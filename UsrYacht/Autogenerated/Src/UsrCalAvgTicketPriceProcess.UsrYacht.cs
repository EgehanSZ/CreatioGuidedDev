namespace Terrasoft.Core.Process
{
	...
	#region Class: UsrCalAvgTicketPriceProcessMethodsWrapper

	/// <exclude/>
	public class UsrCalAvgTicketPriceProcessMethodsWrapper : ProcessModel
	{

		public UsrCalAvgTicketPriceProcessMethodsWrapper(Process process)
			: base(process) {
